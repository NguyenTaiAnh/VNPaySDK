...
//            let newViewController = NewViewControlle()
//            newViewController.value = value
//            self.bridge.viewController.present(newViewController, animated: false)
            self.openSDK(self: self.bridge.viewController, String: value)
       }
        call.resolve([
    ...
    @objc func openSDK(self: UIViewController, String: String) {
        ...
        let paymentUrl = String//@"https://sandbox.vnpayment.vn/tryitnow/Home/CreateOrder"; //bắt buộc, VNPAY cung cấp
...
//
    ...
    @objc func sdkAction(_ notification: Notification?) {
        ...
        print("listener name: conkec ${name} " + name)
